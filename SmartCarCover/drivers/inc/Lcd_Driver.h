...
#define LCD_SCL        	GPIO_Pin_5	//sck//PB13--->>TFT --SCL/SCK
#define LCD_SDA        	GPIO_Pin_7	//si//PB15 MOSI--->>TFT --SDA/DIN
#define LCD_CS        	GPIO_Pin_3	//ss	  //MCU_PB11--->>TFT --CS/CE

#define LCD_LED        	GPIO_Pin_10 //b10 //MCU_PB9--->>TFT --BL
#define LCD_RS         	GPIO_Pin_1	//PB1--->>TFT --RS/DC
#define LCD_RST     	GPIO_Pin_5	//ret,c5//Pc5--->>TFT --RST
