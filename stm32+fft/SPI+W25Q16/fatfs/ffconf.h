...
#define FF_USE_MKFS           1  //格式化功能选择 1:使能
...
#define FF_CODE_PAGE        936  //选择语言，默认是日语 936：简体中文
...
#define FF_VOLUMES      1  //物理磁盘的数量 这里只有spi flash 填1
...
#define FF_MAX_SS            4096 //最大扇区大小，spi flash的扇区大小为4KB
